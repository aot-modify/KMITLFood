...
include 'includes/connect.php';
	...
	if($_SESSION['shopkeeper_sid']==session_id())
	{
		?>
<!DOCTYPE html>
<html lang="en">
    ...
    <div class="wrapper">
      ...
      <aside id="left-sidebar-nav">
        <ul id="slide-out" class="side-nav fixed leftside-navigation">
            ...
            <li class="bold active"><a href="index.php" class="waves-effect waves-cyan"><i class="mdi-editor-border-color"></i> Management</a>
            </li>
                <li class="no-padding">
          ...
          <div class="container">
            <div class="row">
              <div class="col s12 m12 l12">
                <h5 class="breadcrumbs-title">Restaurant Management</h5>
              </div>
            </div>
          </div>
        </div>
...
<table>
                    <thead>
                      <tr>
                        ...
                        <th data-field="name">Food Price/Piece</th>
                      </tr>
                    </thead>
