    ...
    <div class="wrapper">
      ...
      <aside id="left-sidebar-nav">
        <ul id="slide-out" class="side-nav fixed leftside-navigation">
            ...
            <li class="bold"><a href="index.php" class="waves-effect waves-cyan"><i class="mdi-editor-border-color"></i> Restaurant</a>		
...
<table>
				...
				while($row = mysqli_fetch_array($result))
				{
					...
					echo '<td><select name="'.$row['id'].'_role">
					  ...
					  <option value="Shopkeeper"'.($row['role']=='Shopkeeper' ? 'selected' : '').'>Shopkeeper</option>
